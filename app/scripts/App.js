...
var _scripts = __webpack_require__(33);

var _scripts2 = _interopRequireDefault(_scripts);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var template = new _scripts2.default();
...
var _apiRequest = __webpack_require__(34);
...
var GenerateTemplates = function () {
  function GenerateTemplates() {
    _classCallCheck(this, GenerateTemplates);

    this.Head = (0, _jquery2.default)('#head-template');
    this.HeadWrapper = (0, _jquery2.default)('.head-wrapper');
    this.Body = (0, _jquery2.default)('#body-template');
    this.BodyFirstDiv = (0, _jquery2.default)('.body-wrapper div');
    this.BodyWrapper = (0, _jquery2.default)('.body-wrapper');
    this.Error = (0, _jquery2.default)('#error-template');
    this.ErrorWrapper = (0, _jquery2.default)('#error-wrapper');
    this.Button = (0, _jquery2.default)('#button');
    this.Weather = (0, _jquery2.default)('.weather');
    this.events();
  }

  _createClass(GenerateTemplates, [{
    key: 'headTemplate',
    value: function headTemplate(feed) {
      var compile = _handlebars2.default.compile(this.Head.html());
      var render = compile({ templateFeed: feed });
      this.HeadWrapper.html(render);
    }
  }, {
    key: 'bodyTemplate',
    value: function bodyTemplate(feed) {
      var compile = _handlebars2.default.compile(this.Body.html());
      var render = compile({ templateFeed: feed.days });
      this.BodyWrapper.html(render);
      this.BodyFirstDiv.first().attr('class', 'col-sm-2 col-sm-offset-1 col-xs-10 col-xs-offset-1');
    }
  }, {
    key: 'errorTemplate',
    value: function errorTemplate(feed) {
      var compile = _handlebars2.default.compile(this.Error.html());
      var render = compile(feed);
    ...
    value: function generateData() {
      ...
      (0, _apiRequest2.default)((0, _jquery2.default)('#city').val(), 'GET').then(function (response) {
        _this.headTemplate(response);
        _this.bodyTemplate(response);
        _this.Weather.addClass('show-weather');
      }).catch(function (error) {
        _this.errorTemplate({ templateFeed: error });
        _this.ErrorWrapper.attr('class', 'show-error-msg');
        _this.Weather.removeClass('show-weather');
        _this.headTemplate({});
        _this.bodyTemplate({});
      });
    }
...
var sendRequest = function sendRequest(city, method) {
    var http = void 0;
    var dayCounter = 1;
    var front = "https://api.openweathermap.org/data/2.5/forecast/daily?q=";
    var back = "&appid=f631fd357c75163a46154773a513dd64";
    var url = front + city + back;
        ...
        http.onload = function () {
            if (this.readyState === 4 && this.status === 200) {
                ...
                for (var i = 0; i < data.list.length - 2; i++) {
                    weatherInfo.days.push(new _helpers2.default(dayCounter, "http://openweathermap.org/img/w/" + data.list[i].weather[0].icon + ".png", data.list[i].weather[0].description, Math.round(data.list[i].temp.max - 273.15), Math.round(data.list[i].temp.min - 273.15), Math.round(data.list[i].speed * 10) / 10));
                    dayCounter++;
                }
                resolve(weatherInfo);
            }
...
var ObjectCreatror = function ObjectCreatror(dayName, icon, weather, maxTemp, minTemp, windSpeed) {
  _classCallCheck(this, ObjectCreatror);
...
exports.default = ObjectCreatror;
